...
#
# For conveinence/reference, define dictionary that maps Tradier exchange symbols -> Name of exchange
#

# EXCHANGE LIST (`tradier_exchange_list`)
#
# A                                          NYSE
# B                                 NASDAQ OMX BX (Former: Boston Stock Exchange)
# C                       National Stock Exchange (NSX; Former: Cincinnati Stock Exchange)
# D                                     FINRA ADF
# E  Market Independent (Generated by NASDAQ_SIP)
...
# N                                          NYSE
# P                                     NYSE Arca (Arca -> NYSE -> ICE)
# Q                                    NASDAQ OMX (NASDAQ NORDIC)
# S                              NASDAQ Small Cap
# T                                    NASDAQ Int
# U                                         OTCBB
# V                                     OTC Other
...
with open('tradier_exchange_list.json', 'r') as file_name: tradier_exchange_list = json.load(file_name)[0];
